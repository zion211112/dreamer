...
export function ClassPicker({ value, onChange }: Props) {
  ...
  const chip = (on: boolean) =>
    `rounded-full border px-2.5 py-1 font-mono text-[10px] uppercase tracking-[0.12em] transition-colors ${on ? "border-gold bg-gold-soft text-gold" : "border-edge text-dim hover:text-ivory"}`;
