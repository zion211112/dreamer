...
// Four doors, kept verbatim per spec: Youth / Builder / School / Everyone.
        ...
        <div className="wrap">
          ...
          <ul className="doors-list">
            ...
            <li className="door">
              ...
              <p className="door-copy">Bring your school onto the ledger and start a build.</p>
              <Link href="/build/school" className="door-link">Start a build</Link>
            </li>
            <li className="door">
              <span className="door-label">Everyone</span>
              <p className="door-copy">See the floor. Builds, votes, forks.</p>
              <Link href="/benben" className="door-link">See the floor</Link>
            </li>
          </ul>
        </div>
      </section>
