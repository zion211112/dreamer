      ...
      <div className="relative overflow-hidden">
        ...
        <aside className="mt-8 lg:mt-0 lg:sticky lg:top-24">
          <div className="rounded-3xl border border-white/10 bg-panel p-6">
            ...
            <Link href="/zep-tepi/gate" className="mt-4 block text-center rounded-full border border-teal-300/50 px-5 py-2.5 text-sm font-bold text-teal-300 hover:bg-teal-300 hover:text-black transition">
              Enter the gate →
            </Link>
          </div>
        </aside>
