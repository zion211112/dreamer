...
// BenBen Jobs: the operational task board. Tasks, needs, hiring.
// The Forest at /zep-tepi is a separate gated layer; this board stays open.
    ...
    return (
      <main className="bg-obsidian text-ivory">
        <div className="mx-auto max-w-md px-6 py-24 text-center">
          <p className="font-mono text-xs tracking-[0.2em] text-muted">BENBEN JOBS · REGISTERED ONLY</p>
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight">No slot, no work.</h1>
          <p className="mt-3 text-muted">The jobs board opens for registered members. Claim your slot on the ledger first.</p>
    ...
    <main className="bg-obsidian text-ivory">
      <div className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-14">
          <p className="text-xs font-bold tracking-widest text-river">BENBEN JOBS · TASKS + PROJECTS</p>
          <h1 className="mt-3 text-4xl md:text-5xl font-extrabold tracking-tight">Work gets posted. Crews get paid.</h1>
          ...
          <div id="hire" className="mt-14 grid md:grid-cols-2 gap-6 items-start">
            <form onSubmit={postNeed} className="rounded-3xl bg-panel border border-white/10 p-7">
              ...
              <p className="mt-1 text-sm text-muted">Agribusiness grads: manage a farm remotely, hire the crew here. Lecturers: direct a funded build, the jobs board staffs it.</p>
